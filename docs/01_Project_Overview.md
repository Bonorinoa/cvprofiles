...
| Primary | Secondary |
|---|---|
| Augusto (thesis / package / paper) | Empirical researchers who already have multi-measure scores and want disciplined sensitivity |
| Coding agents implementing the engine from these docs | Methods reviewers who need an audit trail |
...
**cvprofiles** — short, package-aligned, matches Hermes profile. Display phrase: *construct-validity profiles*. Symbolic rename is optional later; do not block scaffold on aesthetics.
