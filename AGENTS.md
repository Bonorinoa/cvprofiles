...
- Package version: `2.5.0` — **v2.5.0 infrastructure checkpoint tagged 2026-08-08** (Rev 3 P1–P5 engine go: `corr_zero`/`monotone_rank`, `diff_means`/`map_distance`, stage + units-split holdout, coverage uncertainty band). **2.0.0 remains the latest PyPI release** (tag `v2.0.0` @ `6abb6e4`). P6 ships as its own tag; `v3.0.0` remains Gate C.
